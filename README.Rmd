...
## Function
* `RaoYuAr1()` This function gives estimation of y using Hierarchical Bayesian under Rao Yu Model
* `Panel()` This function gives estimation of y using Hierarchical Bayesian under Rao Yu Model when rho = 0

## Installation
You can install the development version of saeHB.panel from [GitHub](https://github.com/) with:
